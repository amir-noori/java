...
@FacesValidator(value = "superAdminPrivilegeValidator")

public class SuperAdminPrivilegeValidator implements Validator
{	
	
	private UserController userController; 
	private FacesContext context;
	
	public SuperAdminPrivilegeValidator()
	{
    ...
    {	
    	if(!userController.getUser().getIsSuperAdmin())
    	{
